...
source.include_exts = py,png,jpg,kv,atlas,json,ttf,lottie
...
icon.filename = assets/hypload_icon.png
...
icon.adaptive_foreground.filename = assets/hypload_icon_foreground.png
icon.adaptive_background.filename = assets/hypload_icon_background.png
